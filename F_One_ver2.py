...
from thuvien.SpeechToActionVer2 import *
...
def dieu_khien_theo_giong_noi( dk_canhtay_giongnoi ,dk_nhan_dien_hinhanh, tracking_object_status ):
	...
	list_commands = {  "dk_canhtay_giongnoi": dk_canhtay_giongnoi,
                            "dk_nhan_dien_hinhanh": dk_nhan_dien_hinhanh,
							"tracking_object_status": tracking_object_status}
	
	list_commands = assistant(list_commands)    
